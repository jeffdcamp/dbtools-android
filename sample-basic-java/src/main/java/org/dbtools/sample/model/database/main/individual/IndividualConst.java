...
public class IndividualConst {
    ...
    public static final String INSERT_STATEMENT = "INSERT INTO INDIVIDUAL (INDIVIDUAL_TYPE_ID,FIRST_NAME,LAST_NAME,SAMPLE_DATE_TIME,BIRTH_DATE,LAST_MODIFIED,NUMBER,PHONE,EMAIL,DATA,SPOUSE_INDIVIDUAL_ID) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
    public static final String UPDATE_STATEMENT = "UPDATE INDIVIDUAL SET INDIVIDUAL_TYPE_ID=?, FIRST_NAME=?, LAST_NAME=?, SAMPLE_DATE_TIME=?, BIRTH_DATE=?, LAST_MODIFIED=?, NUMBER=?, PHONE=?, EMAIL=?, DATA=?, SPOUSE_INDIVIDUAL_ID=? WHERE _id = ?";
